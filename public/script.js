...
document.addEventListener('DOMContentLoaded', function() {
        ...
        contactForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                    ...
                    body: JSON.stringify({
                        websiteId: 'acc5dd00-9ee9-4892-9e33-3d4136d23f09',
                        name: data.name || '',
                        email: data.email || '',
    ...
    document.querySelectorAll('.feature-card, .product-card, .value-card, .why-card, .safety-card, .faq-item').forEach(el => {
        el.style.opacity = '1';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גומי דאק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
